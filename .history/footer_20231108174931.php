        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.1s">
                    ...
                    <img class="img-fluid border" width="100%" src="img/logo2.jpeg" alt="">
                    </a>
                ...
                <div class="col-md-6 col-lg-4 wow fadeIn" data-wow-delay="0.3s">
                    ...
                    <p><i class="fa fa-map-marker-alt me-3"></i>24-22 Goodmark Place Etobicoke, ON M9W 6R2 Canada</p>
            ...
            <div class="copyright">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        &copy; <a class="border-bottom" href="#">SAT METAL FABRICATION INC.</a>, All Right Reserved.
